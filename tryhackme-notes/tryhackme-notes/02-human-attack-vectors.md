...
Deepfakes are AI-generated audio or video content used to impersonate real people. Attackers may impersonate executives, managers, colleagues, or business partners to create trust and urgency.

Impersonation

Impersonation means pretending to be someone else, such as IT support, a manager, a vendor, a bank, or a trusted colleague.

This can lead to credential theft, MFA approval abuse, remote access installation, unauthorized password resets, or account compromise.
...
Human attack vectors are dangerous because attackers can bypass technical defenses by manipulating users. Social engineering attacks such as phishing, impersonation, malware downloads, deepfakes, and fake support requests can lead to credential theft, malware execution, unauthorized access, and data loss. As a SOC Analyst, I would investigate both the human action and the technical evidence, such as email activity, login logs, MFA events, endpoint alerts, and network connections.
